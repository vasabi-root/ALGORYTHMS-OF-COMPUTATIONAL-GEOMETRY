    ...
    if find_OP_cross(square_P1,square_P2):
        ...
        if (i == len_C):
            ...
            for i in range (0,len(Q)):
                if ((Q[i][0][0] > point[0]) or (Q[i][1][0] > point[0])) and ((Q[i][0][1] <= point[1] and Q[i][1][1] >= point[1]) or (Q[i][0][1] >= point[1] and Q[i][1][1] <= point[1])):
                    print(Q[i])
                    F.append(Q[i])
            K = VPO(F)
...
a = [[[1,1],[1,1],[4,2]],[[1,1],[1,1],[4,2]]]
b = [[4,0],[4,0],[4,2]]
d = [[4,2],[4,2],[4,0]]
A = []
L = [[[1,1],[1,1],[7,4]],[[1,2],[1,2],[4,1]],[[2,4],[2,4],[3,3]],[[1,4],[1,4],[4,7]]]
P = [[[2,1],[10,3]],
     [[1,7],[11,2]],
     [[4,2],[5,3]],
     [[1,4],[2,5]],
...
##A = VPO(S)
#LINESTRING()
#MULTILINESTRING(01 02 00 00 00 04 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 08 40 00 00 00 00 00 00 00 00 00 00 00 00 00 00 10 40 00 00 00 00 00 00 f0 3f 00 00 00 00 00 00 14 40 00 00 00 00 00 00 00 40 00 00 00 00 00 00 14 40)
# ((0, 3, 0, 4, 1, 5, 2, 5), (0.2, 3, 0.2, 4, 1, 4.8, 2, 4.8), (0, 4.4, 0.6, 5))
#for i in range (0,len(A)):
#    print ("A[",i,"] = ",A[i])
#print(TPM(S))
