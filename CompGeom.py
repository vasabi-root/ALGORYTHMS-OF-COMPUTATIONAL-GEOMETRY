...
def one_side(A,M): # проверка вершины многоугольника - True, если оба ребра, формирующих вершину, находятся по одну сторону относительно самой вершины
...
S1 = [[[8,5],[10,5]], ## квадрат 2х2 с левой нижней вершиной в точке [8,5] (для пересечения с G1 или G2 -- для случая, когда ограничивающие прямоугольники пересекаются, а многоугольнки -- нет)
      [[10,5],[10,7]],
      [[10,7],[8,7]],
      [[8,7],[8,5]]]
